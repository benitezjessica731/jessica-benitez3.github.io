...
function greeter(hour) {
    ...
    //create an if, else if, statement, and if depending on hour of day, writing a program greeting as specified
    //between hour 0-11, greet "Good Morning!"
    if (hour >= 0 && hour <= 11) {
        console.log("Good Morning!");
   //between hour 12-16, greet "Good Afternoon!"
    } else if (hour >=12 && hour <= 16) {
        console.log("Good Afternoon!");
    //between hour 17-21, greet "Good Evening"
    } else if (hour >= 17 && hour <= 21) {
        console.log("Good Evening!");
    //beetween hour 22-24, greet "Good Night!"
